...
use WP2D\Dependencies\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `WP2D\Dependencies\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `WP2D\Dependencies\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
